        ...
        <div class="grid min-h-0 flex-1 gap-6 xl:grid-cols-[minmax(0,1.45fr)_minmax(280px,0.55fr)] xl:items-start">
            <div class="min-h-0 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                <div class="flex h-full min-h-0 flex-col">
                    ...
                    <div class="relative min-h-0 flex-1 overflow-hidden px-4 py-4">
                        <div class="absolute inset-x-4 top-0 z-10 h-6 bg-gradient-to-b from-white via-white/90 to-transparent pointer-events-none"></div>
                        <div class="absolute inset-x-4 bottom-0 z-10 h-6 bg-gradient-to-t from-white via-white/90 to-transparent pointer-events-none"></div>
                ...
                @forelse ($operations as $project)
                    ...
                    <button
                        ...
                        class="w-full rounded-3xl border p-3.5 text-left shadow-sm transition {{ $isSelected ? 'border-blue-400 bg-blue-50 ring-2 ring-blue-100' : 'border-slate-200 bg-white hover:-translate-y-0.5 hover:border-slate-300 hover:bg-slate-50 hover:shadow-md' }}"
                    >
                        <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                            <div class="min-w-0">
                                ...
                                <div class="mt-2.5 truncate text-base font-semibold text-slate-950">{{ $project->name }}</div>
