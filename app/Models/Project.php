...
class Project extends Model
{
    ...
    protected $fillable = [
        'name','status','execution_sub_status','client_id',
        'prospection_notes',
        'proposal_url','excel_url','total_cost','installments',
        'estimated_start_date','estimated_end_date',
        'sprint_close_day','actual_start_date','actual_end_date',
    ...
    public function scopeSearch($q, ?string $term)
    {
        ...
        return $q->where('name', 'like', "%{$term}%")
            ->orWhereHas('client', function ($c) use ($term) {
                $c->where('organization_name', 'like', "%{$term}%")
